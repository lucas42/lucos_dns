...
if __name__ == "__main__":
	try:
		...
		updateScheduleTracker(success=True, system="lucos_dns", job_name="config-sync", frequency=(15 * 60))
	except Exception as e:
		error_message = f"Sync failure: {e}"
		updateScheduleTracker(success=False, system="lucos_dns", job_name="config-sync", message=error_message, frequency=(15 * 60))
